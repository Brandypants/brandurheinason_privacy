...
By using the FreshPaws app, you agree to our Privacy Policy and Terms of Service. These outline how we collect and handle your data, and the rules of using our platform.

If you choose to use our service, then you agree to the collection and use of information in accordance with this policy. The personal information we collect is used to provide and improve the service. We will not use or share your information with anyone except as described in this Privacy Policy.  
...
We use Stripe to securely process payments on our platform. FreshPaws does not store your credit card or banking information. All transactions are handled through Stripe's encrypted systems.

If you are dissatisfied with a paid booking or experience a problem, you can contact us at **brandurdeveloper@gmail.com** within 14 days of the transaction to request a refund or dispute a charge. Refunds are handled on a case-by-case basis.
...
This service does not use cookies directly. However, the app may use third-party code and libraries that use cookies to collect information and improve their services. You can choose to accept or decline cookies, but some features of the service may not function properly if cookies are disabled.

---

### Location Information  
Some features of the FreshPaws app rely on location data transmitted from users’ mobile devices. This is only used within the scope necessary to operate and improve the service (such as finding nearby petsitters).
...
Users can book or be booked for pet-related services, including pet-sitting and pet dates. Paid services are processed through Stripe, and users agree to Stripe’s terms when transacting.

FreshPaws may take a commission on paid bookings, which will be transparently displayed before confirming payment.

---

### Cancellations and Refunds  
You may cancel bookings via the app. Refund eligibility depends on timing and service type. Contact **brandurdeveloper@gmail.com** with questions or disputes.
...
FreshPaws is not responsible for any harm, loss, or dispute that occurs between users. We provide a platform for connecting pet owners and sitters but do not directly supervise or vet individual arrangements beyond basic profile information.
